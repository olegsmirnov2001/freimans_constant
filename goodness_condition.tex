...
\begin{equation}\label{12.2} %\tag{12.2}
	0,313 <
	q
...
\begin{equation}\label{goodness_condition_2,9} %\tag{12.3}
	\dfrac{\D_1}{\D_2} < 2,9,
\end{equation}
...
\begin{equation}\label{12.5} %\tag{12.5}
	0,253 < q
...
\begin{equation}\label{goodness_condition_1,4} %\tag{12.6}
	\d' - \d'' > 1,4 (\g' - \g''),
\end{equation}
...
\begin{equation}\label{12.7} %\tag{12.7}
	0,253 < q
...
\begin{equation}\label{12.9} %\tag{12.9}
	0,2885
	<
	q
...
\begin{equation}\label{goodness_condition_3,43} %\tag{12.10}
	\dfrac{\D_1}{\D_2} < 3,43
\end{equation}
